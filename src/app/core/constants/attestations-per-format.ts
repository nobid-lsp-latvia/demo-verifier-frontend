...
import {AGE_OVER_18_ATTESTATION, MDL_ATTESTATION, RTU_ATTESTATION, PID_ATTESTATION} from "@core/constants/attestation-definitions";
...
/*---- RTU ATTESTATION INSTANCES PER FORMAT ----*/
export const RTU_MSO_MDOC: MsoMdocAttestation = {
  format: AttestationFormat.MSO_MDOC,
  attestationDef: RTU_ATTESTATION,
  doctype: 'eu.europa.ec.eudi.rtu_diploma_mdoc',
  namespace: 'eu.europa.ec.eudi.rtu_diploma_mdoc',
  attributePath: (attribute: DataElement) => { return msoMdocAttributePath(attribute, 'eu.europa.ec.eudi.rtu_diploma_mdoc') },
  claimPath: (attribute: DataElement) => { return { namespace: 'eu.europa.ec.eudi.rtu_diploma_mdoc', claim_name: attribute.identifier } }
}
...
export const ATTESTATIONS_BY_FORMAT: { [id: string]: Attestation[] } = {
  "mso_mdoc": [PID_MSO_MDOC, MDL_MSO_MDOC, RTU_MSO_MDOC, AGE_OVER_18_MSO_MDOC],
